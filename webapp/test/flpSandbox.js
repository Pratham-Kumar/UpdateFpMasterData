		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Update FP Master Data",
									"targetURL": "#comsapupdatefpmasterdata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapupdatefpmasterdata-display": {
								"semanticObject": "comsapupdatefpmasterdata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.updatefpmasterdata",
									"url": sap.ui.require.toUrl("com/sap/updatefpmasterdata")
								}
							}
						}
					}
